...
- [1997 DOCUMENTATION GUIDELINES FOR EVALUATION AND MANAGEMENT SERVICES](#1997-documentation-guidelines-for-evaluation-and-management-services)
  - [I. INTRODUCTION](#i-introduction)
    - [WHAT IS DOCUMENTATION AND WHY IS IT IMPORTANT?](#what-is-documentation-and-why-is-it-important)
    - [WHAT DO PAYERS WANT AND WHY?](#what-do-payers-want-and-why)
  - [II. GENERAL PRINCIPLES OF MEDICAL RECORD DOCUMENTATION](#ii-general-principles-of-medical-record-documentation)
  - [III. DOCUMENTATION OF E/M SERVICES](#iii-documentation-of-em-services)
  - [A. DOCUMENTATION OF HISTORY](#a-documentation-of-history)
    ...
    - [PAST, FAMILY, AND/OR SOCIAL HISTORY (PFSH)](#past-family-andor-social-history-pfsh)
  - [B. DOCUMENTATION OF EXAMINATION](#b-documentation-of-examination)
    - [GENERAL MULTI-SYSTEM EXAMINATIONS](#general-multi-system-examinations)
    - [SINGLE ORGAN SYSTEM EXAMINATIONS](#single-organ-system-examinations)
    - [CONTENT AND DOCUMENTATION REQUIREMENTS](#content-and-documentation-requirements)
      - [Cardiovascular Examination](#cardiovascular-examination)
      - [Ear, Nose and Throat Examination](#ear-nose-and-throat-examination)
      - [Eye Examination](#eye-examination)
      - [Genitourinary Examination](#genitourinary-examination)
      - [Hematologic/Lymphatic/Immunologic Examination](#hematologiclymphaticimmunologic-examination)
  ...
  - [C. DOCUMENTATION OF THE COMPLEXITY OF MEDICAL DECISION MAKING](#c-documentation-of-the-complexity-of-medical-decision-making)
    - [NUMBER OF DIAGNOSES OR MANAGEMENT OPTIONS](#number-of-diagnoses-or-management-options)
    - [AMOUNT AND/OR COMPLEXITY OF DATA TO BE REVIEWED](#amount-andor-complexity-of-data-to-be-reviewed)
    - [RISK OF SIGNIFICANT COMPLICATIONS, MORBIDITY, AND/OR MORTALITY](#risk-of-significant-complications-morbidity-andor-mortality)
    - [Table of Risk](#table-of-risk)
  - [D. DOCUMENTATION OF AN ENCOUNTER DOMINATED BY COUNSELING OR COORDINATION OF CARE](#d-documentation-of-an-encounter-dominated-by-counseling-or-coordination-of-care)
...
* *Problem Focused Examination* – should include performance and documentation of one to five elements identified by a bullet (•), whether in a ox with a shaded or unshaded border.
...
<table>
 ...
 <tbody>
  <tr><td>Constitutional                <td><ul><li>Measurement of <b>any three of the following seven</b> vital signs: 1) sitting or standing blood pressure, 2) supine blood pressure, 3) pulse rate and regularity, 4) respiration, ) temperature, 6) height, 7) weight (May be measured and recorded by ancillary staff)
  ...
  <tr><td>Neck                          <td><ul><li>Examination of neck (eg, masses, overall appearance, symmetry, position, crepitus)
  ...
  <tr><td>Cardiovascular                <td><ul><li>Palpation of heart (eg, location, size, thrills)
                                                <li>Auscultation of heart with notation of abnormal sounds and murmurs </li></ul>
                                                    Examination of:
  ...
  <tr><td>Genitourinary                     <td><b>MALE:</b>
                                            <ul><li>Examination of the scrotal contents (eg, hydrocele, spermatocele, tenderness of cord, testicular mass)
                                                ...
                                                <li>Digital rectal examination of prostate gland (eg, size, symmetry, nodularity, tenderness) </li></ul>
  ...
  <tr><td>Musculoskeletal               <td><ul><li>Examination of gait and station 
                                                <li>Inspection and/or palpation of digits and nails (eg, clubbing, cyanosis, inflammatory conditions, petechiae, ischemia, infections, nodes) </li></ul>
  ...
  <tr><td>Psychiatric                   <td><ul><li>Description of patient’s judgment and insight </li></ul>
...
<table>
 <thead>
  <tr><th>System/Body Area                      <th>Elements of Examination
 <tbody>
  <tr><td><b>Constitutional</b>         <td><ul><li>Measurement of <b>any three of the following seven</b> vital signs: 1) sitting or standing blood pressure, 2) supine blood pressure, 3) pulse rate and regularity, 4) respiration, ) temperature, 6) height, 7) weight (May be measured and recorded by ancillary staff)
                                                <li>General appearance of patient (eg, development, nutrition, body habitus, deformities, attention to grooming) </ul>
  ...
  <tr><td>Neck                          <td><ul><li>Examination of jugular veins (eg, distension; a, v or cannon a waves)
                                                <li>Examination of thyroid (eg, enlargement, tenderness, mass) </ul>
  <tr><td><b>Respiratory</b>            <td><ul><li>Assessment of respiratory effort (eg, intercostal retractions, use of accessory muscles, diaphragmatic movement)
                                                <li>Auscultation of lungs (eg, breath sounds, adventitious sounds, rubs) </ul>
  <tr><td><b>Cardiovascular<b>          <td><ul><li>Palpation of heart (eg, location, size and forcefulness of the point of maximal impact; thrills; lifts; palpable S3 or S4)
                                                <li>Auscultation of heart with notation of abnormal sounds and murmurs
                                                <li>Measurement of blood pressure in two or more extremities when indicated (eg, aortic dissection, coarctation) </li></ul>
                                                    Examination of:
  ...
  <tr><td><b>Gastrointestinal(Abdomen)</b><td><ul><li>Examination of abdomen with notation of presence of masses or tenderness
                                                <li>Examination of liver and spleen
  ...
  <tr><td><b>Neurologic/Psychiatric</b>         <td>Brief assessment of mental status including
                                            <ul><li>Orientation to time, place and person,
                                                <li>Mood and affect (eg, depression, anxiety, agitation) </ul>
</table>
...
<table>
 ...
 <tbody>
  ...
  <tr><td><b>Head and Face<b>           <td><ul><li>Inspection of head and face (eg, overall appearance, scars, lesions and masses)
  ...
  <tr><td><b>Ears, Nose, Mouth and Throat</b><td><ul><li>Otoscopic examination of external auditory canals and tympanic membranes including pneumo-otoscopy with notation of mobility of membranes
  ...
  <tr><td><b>Neck<b>                    <td><ul><li>Examination of neck (eg, masses, overall appearance, symmetry, tracheal position, crepitus)
                                                <li>Examination of thyroid (eg, enlargement, tenderness, mass) </ul>
  ...
  <tr><td>Skin                          <td>
  <tr><td>Neurologic/Psychiatric        <td><ul><li>Test cranial nerves with notation of any deficits </ul>
                                                    Brief assessment of mental status including:
                                            <ul><li>Orientation to time, place and person
                                                <li>Mood and affect (eg, depression, anxiety, agitation) </ul>
</table>
...
<table>
 ...
 <tbody>
  ...
  <tr><td>Head and Face                 <td>
  <tr><td>Eyes                          <td><ul><li>Test visual acuity (Does not include determination of refractive error)
  ...
  <tr><td>Musculoskeletal               <td>
  <tr><td>Skin                          <td>
  <tr><td>Neurologic/Psychiatric        <td><ul><li>Brief assessment of mental status including:
                                            <ul><li>Orientation to time, place and person
                                                <li>Mood and affect (eg, depression, anxiety, agitation) </ul>
</table>
